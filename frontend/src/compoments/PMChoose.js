  ...
  const cards = [
    {
      ...
      desc: 'Manage machines, categories, and operations',
      icon: '🏭',
      path: '/MachineDashBoardPage',
    },
    {
      title: 'Delivery Management',
      desc: 'Track routes, schedules, and dispatches',
      icon: '🚚',
      path: '/DeliveryDashBoardPage',
    },
  ];
  ...
  return (
    <section style={styles.section}>
      <div style={styles.headerWrap}>
        <h1 style={styles.title}>Production Manager</h1>
        <p style={styles.subtitle}>Choose a module to manage your plant operations</p>
      </div>
